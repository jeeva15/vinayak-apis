...
$campaignlist = $campaign->getProjectList();
	...
	<div align="center">
		...
		<table cellpadding="1" cellspacing="1" border="0" bgcolor="#EEEEEE" width="100%" class="mediumtxt">
			...
			<tr id="row_<?php echo $i?>" bgcolor="#FFFFFF">
				<td><?php echo $i?></td>				
				<td><?php echo $campaignval["projectName"];?></a></td>
				
				<td><?php if($campaignval["projectStatus"] == 1) { echo "Active";} else{ echo "Closed";}?></td>
				
				<td><a href="#" onclick='_getBox("editproject.php?page=Edit&ac=<?php echo $commonObj->Encrypt($campaignval["projectId"]);?>","40%","40%")'><img src="images/edit.gif" border="0" alt="edit" title="Edit"></a> &nbsp; &nbsp;<a href="javascript:void(0)" onclick="confimuser('<?php echo $commonObj->Encrypt($campaignval["projectId"]);?>','<?php echo $i?>');"><img src="images/close.gif" border="0" alt="Delete" title="Delete"></td>
